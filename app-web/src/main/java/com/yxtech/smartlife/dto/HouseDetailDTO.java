...
public class HouseDetailDTO {
    ...
    public static HouseDetailDTO fromEntity(HouseDetail entity, ObjectMapper objectMapper) {
        if (entity == null) {
            return null;
        }
    ...
    private static List<String> getApplianceLabels(List<String> appliances) {
        ...
        return appliances.stream().map(HouseDetailDTO::getApplianceLabel).toList();
    }
